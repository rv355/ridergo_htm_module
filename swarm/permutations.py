...
permutations = {
  ...
  u'speed': PermuteEncoder(maxval=38.0, fieldName='speed', w=21, clipInput=True, minval=0.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=38.0, classifierOnly=True, clipInput=True, minval=0.0, n=PermuteInt(28, 521), fieldname='speed', w=21, type='ScalarEncoder', ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=speed")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=speed"
