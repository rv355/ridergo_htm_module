...
control = {
  ...
  #
  'dataset' : {   u'info': u'speed',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Speed Data',
                            u'source': u'file://speeddata_small.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'speed',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'speed', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'speed', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
